...
public class CobasE411 implements SerialPortEventListener {
	private static final Logger logger = Logger.getLogger(CobasE411.class);
	...
	public void SendTest(String qPatientID, SerialPort serialPort) {
		try {
			...
			if (patienList.size() > 0) {
				...
				frameNumber = (frameNumber + 1) % 8;
				str = "";
				str = String.valueOf(frameNumber) + "O|1|" + qPatientID + "|" + componentOfQ[2].toString() + "^"
